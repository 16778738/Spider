        ...
        for name in name_list[::-1]:
            for page in range(1, 100, 10):
                url = 'https://sp0.baidu.com/8aQDcjqpAAV3otqbppnN2DJv/api.php?' \
                      ...
                      '&cardNum=&iname=' + str(name) + '&areaName=&pn={}&rn=10&from_mid=1&ie=utf-8&oe=utf-8&format=json&t=1602596826795&cb=jQuery110209240172210103437_1602596429318&_=1602596429324'.format(page)
